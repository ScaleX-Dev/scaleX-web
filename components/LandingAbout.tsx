    ...
    <div className=" relative flex flex-col items-center justify-center text-center w-full overflow-x-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 justify-items-center w-full mt-5 md:mt-12 px-4 md:px-16">
        ...
        <div className="flex flex-col items-center text-center">
          <button className="bg-primary-green text-black px-3 py-1 hover:bg-primary-green/90 transition rounded-full border border-black">
            Projects
          </button>
      ...
      {/* CTA Button */}
      <Link href="/about">
        <button className="mt-12  text-black px-6 py-3 rounded-full border-black border hover:bg-primary-green/90 transition text-sm md:text-m font-medium bg-primary-green">
