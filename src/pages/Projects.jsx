...
const ProjectsPage = () => {
  ...
  return (
    <div>
      ...
      <Navbar />
      <section className="container mx-auto mt-30 px-4 py-10">
        <div className="grid gap-10">
          {clients.map((client, index) => (
            ...
            >
              <div
                className={`flex-1 sm:w-6/10 w-full ${
              ...
              >
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {client.tags.map((tag, i) => (
                    <span
                      key={i}
                      className="text-sm px-2 py-1/2 rounded-full border-black border-1"
                    >
                      • {tag}
                    </span>
                  ))}
              ...
              <div
                className="relative sm:w-4/10 w-full h-full bg-gray-300 flex items-center justify-center rounded-xl cursor-pointer"
