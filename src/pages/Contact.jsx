    ...
    <div className="isolate bg-[#FAFAFA]">
      ...
      <div className="mx-auto max-w-3xl text-center pt-45">
        ...
        <p className="mt-10 text-lg/8 text-gray-600">
          Interested in working with us? Share your expectations and specific
          needs with us. <br></br> Reach out today, and let’s explore how we can
              ...
              <div className="flex rounded-md bg-white outline-1 -outline-offset-1 outline-gray-300 has-[input:focus-within]:outline-2 has-[input:focus-within]:-outline-offset-2 has-[input:focus-within]:outline-indigo-600">
                <div className="grid shrink-0 grid-cols-1 focus-within:relative">
                  <select
                    ...
                    aria-label="Country"
                    className="col-start-1 row-start-1 w-full appearance-none rounded-md py-2 pr-7 pl-3.5 text-base text-gray-500 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/8"
                  >
                    <option>US</option>
                    <option>CA</option>
                    <option>EU</option>
                ...
                <input
                  ...
                  className="block min-w-0 grow py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/8"
                />
              </div>
            </div>
          </div>
