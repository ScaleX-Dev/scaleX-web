    ...
    <div className="isolate bg-[#FAFAFA]">
      ...
      <div className="mx-auto max-w-3xl text-center pt-45">
        ...
        <p className="mt-10 text-lg/8 text-gray-600">
          Want to build something great together?<br></br> Let's hop on a free
          discovery call and explore how we can create impactful synergies.
        </p>
      </div>
      <form
        action="#"
        method="POST"
        className="mx-auto my-16 max-w-xl sm:mt-20"
      >
            ...
            <div className="mt-2.5">
              <div className="flex rounded-md bg-white outline-1 -outline-offset-1 outline-gray-300 has-[input:focus-within]:outline-2 has-[input:focus-within]:-outline-offset-2 has-[input:focus-within]:outline-indigo-600">
                ...
                <input
                  ...
                  className="block min-w-0 grow py-1.5 pr-3 pl-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/8"
                />
              </div>
            </div>
          </div>
        ...
        <div className="mt-10">
          <button
            type="submit"
            className="block w-full rounded-md bg-black px-3.5 py-2.5 text-center text-sm font-semibold text-primary-green shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
          >
            Let's talk
          </button>
        </div>
